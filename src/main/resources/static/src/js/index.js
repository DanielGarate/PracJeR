...
class SignIn extends Phaser.Scene {
  constructor() {
    super({ key: 'signIn' });
    this.button = new button(this,'menuIni',230,410,'buttonPl');
  ...
  create() {
    this.add.text(250, 300, 'Enter your name:', { font: '16px Courier', fill: '#ffffff' });
    this.button.create();
	

    var textEntry = this.add.text(410, 290, '', { font: '32px Courier', fill: '#ffff00' });
...
var config = {     //Contiene un json
  ...
  parent: "container",
  type: Phaser.AUTO,
  scene: [SignIn, menuIni,Game,pantallaFin,Credits,pantallaFinJugador,Pause],
